...
export default function Sidebar({ mobile, onClose }) {
  ...
  return (
    <>
      <aside className="flex flex-col h-full bg-white dark:bg-slate-800 border-r border-slate-100 dark:border-slate-700 transition-colors duration-300" style={{ width: mobile ? 272 : 252 }}>
        <div className="flex items-center justify-between px-5 py-4 border-b border-slate-100 dark:border-slate-700 flex-shrink-0 transition-colors duration-300">
          <HudumaLogo size="md" />
          {mobile && (
            <button onClick={onClose} className="p-1.5 rounded-lg text-slate-400 dark:text-slate-500 hover:bg-slate-100 dark:hover:bg-slate-700 transition-colors ml-2">
        ...
        <div className="px-3 py-3 border-b border-slate-100 dark:border-slate-700 flex-shrink-0 transition-colors duration-300">
          <div className="flex items-center gap-3 px-3 py-2.5 rounded-xl bg-slate-50 dark:bg-slate-700 transition-colors duration-300">
        ...
        <div className="px-3 pb-4 pt-2 border-t border-slate-100 dark:border-slate-700 flex-shrink-0 transition-colors duration-300">
          <button onClick={() => setShowLogout(true)}
            className="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-[13.5px] font-medium text-slate-500 dark:text-slate-400 hover:bg-red-50 dark:hover:bg-red-900/20 hover:text-red-600 dark:hover:text-red-400 transition-all duration-150">
            <NavIcon name="logout" />
            Sign Out
          </button>
        </div>
